...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.4e54e8b0dd55ff2db963793d333934f80e7dc82721367caa242477724de092fe.js',function(){input.required=false;search();});}
