...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.fb9be81080b72fc62f7ef058d5642755daea126bd018a1444956330ac891c465.js',function(){input.required=false;search();});}
