...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.459a918d6707ded2260ea5bab17bf75b369967f666293aa5d17abafb9e28d9bd.js',function(){input.required=false;search();});}
