...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.26b9deaa7f73fe589efa7e1aaae1f5eff1365d577acf34cb32fc0bfda44e5b02.js',function(){input.required=false;search();});}
