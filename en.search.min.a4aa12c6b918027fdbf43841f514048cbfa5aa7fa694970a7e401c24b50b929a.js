...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.2b83a9e2e5525097129204d1cefa441543ddadb67d398c6c625bb375e8d4d366.js',function(){input.required=false;search();});}
