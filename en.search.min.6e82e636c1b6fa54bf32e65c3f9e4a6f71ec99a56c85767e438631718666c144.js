...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.3f06f72e11be7befebbf69b19eac71292a096ceaa5af36561d19a7115fbbf443.js',function(){input.required=false;search();});}
