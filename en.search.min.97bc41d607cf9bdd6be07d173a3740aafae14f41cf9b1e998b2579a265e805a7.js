...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.7facce3fd42c5be0fde71b64203e4aa6494b005234071b7492de6f2e7f4e0c8d.js',function(){input.required=false;search();});}
