...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.ed2a5775d11a2185bbc0059dc399356c1a6f8f7638836a39018bea3d8102d912.js',function(){input.required=false;search();});}
