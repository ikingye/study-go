...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.08b601e459fd0caf70eef80cbccd496154fccb8782fdd64ae67f3d0607b9a0e8.js',function(){input.required=false;search();});}
