...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.efbe98a45afb7834d0c0d15dfd86cce0d1321dcbe4067bf71abcf022cca34a3b.js',function(){input.required=false;search();});}
