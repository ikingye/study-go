...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.4aae52bc00d13b20419bf21db228b92d73db5a12d52d0a7875fc21e9eb138a41.js',function(){input.required=false;search();});}
