...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.55f0c7aa3e8bd4eefccfed4a8f7a1f06c368d3efd6b4ad6dd366233bf896c8f6.js',function(){input.required=false;search();});}
