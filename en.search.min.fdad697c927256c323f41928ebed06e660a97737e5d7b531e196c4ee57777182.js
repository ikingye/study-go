...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.f857589667757398cd4cb563267399da3c67ed686ca26db8cbffa6785e746fa7.js',function(){input.required=false;search();});}
