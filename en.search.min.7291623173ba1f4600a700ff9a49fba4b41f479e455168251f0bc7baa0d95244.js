...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.ad657ff24d0867bd0442809685bf3cbadcdbf035f367690e009824869eaebc6c.js',function(){input.required=false;search();});}
