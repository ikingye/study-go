...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.968d2fcf643f4dd34df80b1d3e3ac1db3d0a4599e0f22e1dc6a70bbbaa5719d3.js',function(){input.required=false;search();});}
