...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.edc6ca625a4317e3cebe1be4afd13031b7c8e2b65fab261c0cd0f19b89aab902.js',function(){input.required=false;search();});}
