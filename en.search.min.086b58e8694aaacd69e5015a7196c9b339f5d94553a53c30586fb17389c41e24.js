...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.aff7a91e8785bd5799e64eccaa941b51f701aeb490a4a4824a060798d1d64fb9.js',function(){input.required=false;search();});}
