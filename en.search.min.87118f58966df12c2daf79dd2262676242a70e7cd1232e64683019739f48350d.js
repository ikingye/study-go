...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.2f7902ec0912aa6bf850c1016dbadd4672556d26a0b0a8f28fdac132b5b3eca8.js',function(){input.required=false;search();});}
