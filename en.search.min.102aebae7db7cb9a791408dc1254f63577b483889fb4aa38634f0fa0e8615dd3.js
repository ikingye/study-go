...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.6feae576004087741edda73192803274b801d9eb090ddc6e893bd6dfedab36af.js',function(){input.required=false;search();});}
