...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.1007d9ddaa8275a4dd11865312265dcc6e94faf6ca5128f91c9f4702d1e048a0.js',function(){input.required=false;search();});}
