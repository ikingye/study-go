...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.756cad942abab8d2b7db02a1b6928d6e13d24d41883c2077e7afd472a5f01430.js',function(){input.required=false;search();});}
