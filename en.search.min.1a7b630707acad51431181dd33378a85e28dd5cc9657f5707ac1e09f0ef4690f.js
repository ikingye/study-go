...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-go/flexsearch.min.js');loadScript('/study-go/en.search-data.min.d1e35f1dca575bfd8b236be1a1eec4dbcc24b55094f5e144a75686cc39300998.js',function(){input.required=false;search();});}
